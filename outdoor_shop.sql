...
-- Dumping data for table outdoor_shop.products: ~32 rows (approximately)
...
INSERT INTO `products` (`id_products`, `id_categories`, `name`, `price`, `stock`, `description`, `img`) VALUES
	...
	(16, 1, 'EXTRATERRESIAL BACK-Blue', 1870000, 5, 'memiliki reputasi baik sebagai carrier yang tahan lama dan memiliki kualitas back system yang baik. Back system carrier ini dibuat menggunakan teknologi Wind Tunnel yang mengurangi kontak antara punggung Anda dengan bagian belakang carrier sehingga tidak terasa panas saat digunakan.\r\n\r\nCarrier ini juga memiliki fungsi hydration compatible, yaitu kantong di bagian atas carrier yang bisa digunakan untuk menyimpan air minum dan memudahkan Anda saat ingin meminum air. Oleh karena itulah carrier ini ', 'EXTRATERRESSIAL BLUE.jpg'),
	...
	(26, 3, 'DOME FIT-Orange Red', 6000000, 10, 'Sebagai salah satu jenis tenda yang paling banyak digunakan oleh para petualang, tenda kubah atau dome adalah salah satu jenis tenda yang paling populer. Memiliki ciri khas pada bentuk melengkung pada tiang-tiang penyangganya, tenda jenis ini cocok sekali untuk lo bawa ke spot petualangan yang tidak memiliki cuaca ekstrim. Keunggulan dari tenda ini adalah mudah mendirikannya, bentuk depan yang bagus, jumlah penyangga yang lebih dari tiga, dan juga memiliki harga yang paling murah dari yang palin', 'DOME FIT (ORANGE RED).jpg'),
...
-- Dumping data for table outdoor_shop.transactions: ~10 rows (approximately)
...
INSERT INTO `transactions` (`id_trans`, `date`, `id_user`, `grandtotal`, `status`, `receipt`) VALUES
	...
	(35, '2019-05-18 15:32:50', 11, 1450000, 0, 'tepung.jpg'),
	(36, '2019-05-18 15:36:30', 11, 1250000, 0, 'tepung.jpg'),
	(37, '2019-05-18 15:38:35', 11, 185000, 2, 'tepung.jpg'),
	...
	(52, '2019-10-16 12:56:35', 12, 1200000, 1, NULL);
...
-- Dumping data for table outdoor_shop.transactions_detail: ~12 rows (approximately)
...
INSERT INTO `users` (`id_user`, `fullname`, `email`, `username`, `password`, `role`) VALUES
	...
	(14, 'Denny Nur Ramadhan', 'denny.dand@outlook.com', 'ddand', '9e3895cedfa93fc7d6f63cb00ad91d1b', 'admin'),
	(20, 'Halo', 'halo@sekai.com', 'halo', '202cb962ac59075b964b07152d234b70', 'user');
