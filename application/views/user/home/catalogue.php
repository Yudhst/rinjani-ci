    ...
    <div class="mini-card-containerku">
        ...
        <div class="item-container">
            ...
            <div class="item-card">
                ...
                <br>
                    <input type="hidden" name="id" value="<?= $p->id_products ?>">
                    <?php if(empty($this->session->userdata('id_user'))): ?>
                    <button class="btnku btnku-putih" onclick="return confirm('Please Login first')">
                        <i class="fas fa-cart-plus    "></i>
                        <span>Add to Cart</span>
                    </button>
                    <?php endif ?>
                    <a href="<?= base_url().'home/detail/'.$p->id_products?>" class="btnku btnku-putih">
